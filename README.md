...
Все файлы лежат в одной папке, без вложенных: `index.html` и фотографии рядом с ним.
...
- В этой версии добавлены фотографии кейса 06 «Fashion meets horses» (case6-1…case6-4.jpg).
